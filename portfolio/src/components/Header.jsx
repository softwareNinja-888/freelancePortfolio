...
export function Header(){
	...
	return ( 
		 ...
		 <div className="flex justify-between items-center w-screen px-10 py-12">
            ...
            <nav className="hidden lg:flex space-x-20 text-sm text-white font-mont ">
                ...
                <div className=" flex gap-1.5 no-underline relative cursor-pointer text-inherit after:content-[''] after:absolute after:-bottom-0.5 after:left-0 after:w-full after:h-0.5 after:opacity-0 after:transition-opacity after:duration-300 after:ease-in-out hover:after:opacity-100 hover:after:bg-[#f0ef13] text-base max-[500px]:text-xs"  onClick={()=>{toSection('subscribe')}}>
                    Projects
                </div>
